      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-[0.2em]">
              Hi, I am
            </p>
            <div className="flex items-center gap-4">
              <div className="relative h-16 w-16 overflow-hidden rounded-2xl border-2 border-gray-200 shadow-sm dark:border-gray-700">
                <Image
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 font-medium">
              Software Engineer | Full Stack Developer | ML Developer
            </p>
            ...
            <div className="flex space-x-4 pt-4">
              <a
                ...
                aria-label="Email"
                className="w-10 h-10 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-md flex items-center justify-center hover:bg-gray-700 dark:hover:bg-gray-200 transition-colors shadow-sm"
              >
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <Link
                href="/projects"
                className="px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-md font-medium hover:bg-gray-700 dark:hover:bg-gray-200 transition-colors shadow-sm"
              >
                View Projects
              </Link>
              <Link
          ...
          <div className="hidden lg:block animate-slide-up">
            <div className="relative w-full h-96">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100 dark:from-gray-800 to-gray-200 dark:to-gray-700 rounded-xl transform rotate-3 shadow-sm"></div>
              <div className="absolute inset-0 bg-gray-900 dark:bg-white rounded-xl transform -rotate-3 flex items-center justify-center shadow-lg">
                <div className="text-white dark:text-gray-900 text-center space-y-4">
                  <div className="text-6xl font-mono font-bold">RK</div>
                  <div className="text-sm uppercase tracking-widest">Full Stack Developer</div>
                </div>
              </div>
            </div>
          </div>
